	...
	<header class="topbar" data-navbarbg="skin6">
		...
		<div id="socketAlert"
			...
			<button type="button" class="close" data-dismiss="alert"
				aria-label="Close" style="padding: 5px 30px;" id="closeAlert">
				<span aria-hidden="true">×</span>
			</button>
			<span class="font-weight-bold" style="font-size: 17px;"><i
				class="fas fa-envelope"></i>&nbsp;&nbsp; 알림 &nbsp;- &nbsp;</span> <span
				id='socketAlertMsg' style="font-size: 17px;"> 새 메세지가 도착했습니다!
			</span>
		</div>
		...
		<nav class="navbar top-navbar navbar-expand-md">
			<div class="navbar-header" data-logobg="skin6">
				...
				<div class="navbar-brand">
					<!-- Logo icon -->
					<a href="${ pageContext.servletContext.contextPath }"> <b
						class="logo-icon"> <!-- Dark Logo icon --> <img
							src="${ pageContext.servletContext.contextPath }/resources/assets/images/logo-icon7.png"
							alt="homepage" class="dark-logo" /> <!-- Light Logo icon --> <img
							src="${ pageContext.servletContext.contextPath }/resources/assets/images/logo-icon.png"
							alt="homepage" class="light-logo" />
					</b> <!--End Logo icon --> <!-- Logo text --> <span class="logo-text">
							<!-- dark Logo text --> <img
							src="${ pageContext.servletContext.contextPath }/resources/assets/images/logo-text3.png"
							alt="homepage" class="dark-logo" /> <!-- Light Logo text --> <img
							src="${ pageContext.servletContext.contextPath }/resources/assets/images/logo-light-text.png"
    ...
    if(${loginUser.empNo} == 200){
    	...
    	$.ajax({
    		...
    		success:function(result){
    			if(result > 0){
    	             if((location.pathname == "/spring/login.me") || (location.pathname == "/spring/") ){
