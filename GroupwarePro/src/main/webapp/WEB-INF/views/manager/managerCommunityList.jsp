												...
												<td class="nav-item dropdown"><a
													...
													<div
														...
														<a class="dropdown-item" href="openCategory.co?cno=${c.cno}"> 
															...
															<a style="color:red;" class="dropdown-item" href="closeCategory.co?cno=${c.cno}"> 
                                								<svg
																xmlns="http://www.w3.org/2000/svg" width="24"
																height="24" viewBox="0 0 24 24" fill="none"
																stroke="currentColor" stroke-width="2"
												...
												<td class="nav-item dropdown"><a
													...
													<div
														...
														<c:if test="${c.status eq 'X' }">
															...
															<a style="color:red;" class="dropdown-item" href="openCategory.co?cno=${c.cno}"> 
                                								<svg
																xmlns="http://www.w3.org/2000/svg" width="24"
																height="24" viewBox="0 0 24 24" fill="none"
																stroke="currentColor" stroke-width="2"
