				...
				<div class="row" style="height: 100%;">
					...
					<div class="col-2" style="border-right: 1px solid rgba(0,0,0,.125);">
                        ...
                        <div class="list-group"> 
			           		<a href="#" class="list-group-item">내 근태 현황</a>
                        	<a href="#" class="list-group-item">내 연차 내역</a> 
                        	<a href="#" class="list-group-item">내 인사정보</a> 
                       	</div>
					</div>
					...
					<div class="col-10">
						...
						<div class="row">
							<div class="col-md-12 m-auto">
								<div class="d-flex col-10 m-auto" style="border: 1px solid rgba(0,0,0,.125); background-color: white">
