				...
				<div class="row" style="min-height: 500px;">
					...
					<div class="col-10">
						...
						<div class="row" style="border-bottom: 1px solid rgba(0,0,0,.125);">
							...
							<c:choose>
								<c:when test="${not empty efList}">
									<c:forEach var="ef" items="${efList }">
										<div class="d-flex col-12 dLists">
											<div class="col-2">
												<span><fmt:formatDate value="${ef.createDate}" type="date" pattern="yyyy-MM-dd"/></span>
											</div>
											<div class="col-7">
												<span class="title">${ef.FName}<input type="hidden" value="${ef.FNo }"></span>
											</div>
											<div class="col-1">
												<span></span>
											</div>
											<div class="col-2">
												<span>${ef.creatorName}</span>
											</div>
										</div>
									</c:forEach>
								</c:when>
								<c:otherwise>
									<div class="d-flex col-12">
										<span class="m-auto">문서가 없습니다.</span>
									</div>
								</c:otherwise>
							</c:choose>
						</div>
